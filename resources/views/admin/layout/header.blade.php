                                    ...
                                    <li class="dropdown chats-dropdown hide-mb-xs">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right">
                                            <div class="dropdown-head">
                                                <span class="sub-title nk-dropdown-title">Tin Nhắn Gần Đây</span>
                                                <a href="#">Cài Đặt</a>
                                            </div>
                                            ...
                                            <div class="dropdown-foot center">
                                                <a href="html/apps-chats.html">Hiển Thị Tất Cả</a>
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span
                                                            class="lead-text">{{ Auth::guard('nv')->user() ? Auth::guard('nv')->user()->ten: "User"}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="#"><em
                                                                class="icon ni ni-user-alt"></em><span>Hồ Sơ</span></a></li>
                                                    <li><a href="#"><em
                                                                class="icon ni ni-setting-alt"></em><span>Cài Đặt</span></a></li>
                                                    <li><a href="#"><em
                                                                class="icon ni ni-activity-alt"></em><span>Hoạt Động Đăng Nhập</span></a></li>
